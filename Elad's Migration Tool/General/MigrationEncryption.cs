...
namespace Elad_s_Migration_Tool.General
{
    ...
    {
        public static string ENCRYPTION_PASSWORD = "fkjgh39thdshDKGHkhg394fghjd";
        ...
        public static void outputEncryptedString(string text)
        {
            Helper.writeLineToText("encryptionOutput.txt", text + " - " + Encrypt(text, ENCRYPTION_PASSWORD));
        }
